...
#filepath = '/home/leavesnight/zzh/VIEO_SLAM/Examples/Monocular/';
#filepath = '/home/leavesnight/zzh/VIEO_SLAM/Examples/Stereo/';
filepath = '/home/leavesnight/zzh/VIEO_SLAM/Examples/RGB-D/';
...
plt.savefig(filepathOut+'Pw.eps', format="eps");
...
plt.title('gyr bias');
plt.savefig(filepathOut+'biasgyr.eps', format="eps");
...
plt.title('acc bias');
plt.savefig(filepathOut+'biasacc.eps', format="eps");
...
plt.savefig(filepathOut+'Vw.eps', format="eps");
